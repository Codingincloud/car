...
const LandingPage = () => {
    ...
    return (
        <div className="min-h-screen relative overflow-hidden flex flex-col items-center justify-center p-6 text-white selection:bg-primary/30">
            ...
            >
                ...
                <div className="flex justify-center mb-8">
                    <motion.div
                        ...
                        className="bg-white/5 backdrop-blur-xl p-6 rounded-3xl border border-white/10 shadow-[0_0_30px_rgba(16,185,129,0.3)]"
                    >
                ...
                <p className="text-xl md:text-2xl text-text-muted max-w-2xl mx-auto leading-relaxed font-light">
                    ...
                    <br />
                    <span className="text-white font-medium">Measure</span>, <span className="text-white font-medium">Reduce</span>, and <span className="text-white font-medium">Evolve</span> towards a sustainable future.
                </p>
                ...
                <div className="pt-8">
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="group relative inline-flex items-center justify-center px-10 py-5 text-lg font-bold text-white transition-all duration-200 bg-primary/90 rounded-full hover:bg-primary hover:shadow-[0_0_40px_rgba(16,185,129,0.4)] overflow-hidden"
                    >
